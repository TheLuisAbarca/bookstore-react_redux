...
[Live Demo Link](https://theluisabarca.github.io/bookstore-react_redux/)  
...
> `git clone https://github.com/TheLuisAbarca/bookstore-react_redux`.
- Enter in the folder `bookstore-react_redux` and write the command:
> `npm install`
